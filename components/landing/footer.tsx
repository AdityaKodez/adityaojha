...
export function Footer() {
  return (
    <footer className="overflow-hidden border-t pb-[calc(60px+env(safe-area-inset-bottom))]  border-dashed bg-muted/20">
      ...
      <div className="border-y border-dashed px-6  py-2 md:px-8">
